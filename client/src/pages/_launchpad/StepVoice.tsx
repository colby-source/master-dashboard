import { Field, Textarea, Chips, StepHeader } from './_primitives';
  ...
  return (
    <div className="space-y-6">
      <StepHeader
        ...
        subtitle="How this brand talks — and what it never sounds like."
      />
      ...
      <Field label="Off-limits topics">
        <Chips
          values={intake.off_limits_topics || []}
          onChange={(v) => update({ off_limits_topics: v })}
          placeholder="politics, weight-loss claims…"
        />
      </Field>
      <Field label="Visual style notes" hint="clean / maximalist / earthy / clinical — or a reference brand.">
        <Textarea
          rows={2}
          value={intake.visual_style_notes || ''}
